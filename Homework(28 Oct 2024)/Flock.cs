...
public class Flock : MonoBehaviour
{
    ...
    //Syukri 24000074
    //function to delete drone by id

    [SerializeField] private TMP_InputField droneIdInputField;
    public void LinkedListDeleteDrone()
    {
        ...
        // Find the drone by ID/index
        Drone drone = droneComm.FindDroneById(droneId);
        if (drone != null)
        {
